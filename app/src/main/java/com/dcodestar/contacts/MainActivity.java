package com.dcodestar.contacts;
...
//    private static final boolean READ_CONTACTS_GRANTED=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactNames=findViewById(R.id.list_view);
...
//                if(!READ_CONTACTS_GRANTED) {
                if(ContextCompat.checkSelfPermission(MainActivity.this,READ_CONTACTS)!=PackageManager.PERMISSION_GRANTED){
                    Snackbar.make(view,"Grant Contacts Permission",Snackbar.LENGTH_INDEFINITE).setAction("action", new View.OnClickListener() {
                        @Override
